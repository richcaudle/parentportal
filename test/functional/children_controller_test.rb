...
class ChildrenControllerTest < ActionController::TestCase
  ...
  test "should create child" do
    assert_difference('Child.count') do
      post :create, child: { class_id: @child.class_id, dob: @child.dob, firstname: @child.firstname, lastname: @child.lastname, picture: @child.picture }
    end
  ...
  test "should update child" do
    put :update, id: @child, child: { class_id: @child.class_id, dob: @child.dob, firstname: @child.firstname, lastname: @child.lastname, picture: @child.picture }
    assert_redirected_to child_path(assigns(:child))
  end
